...
export const PROVIDERS: ProviderEntry[] = [
  ...
  },
  {
    ...
    emoji: "🛡️",
    envVars: ["SENTRY_DSN"],
    help: "Error tracking for server-side errors.",
    href: "https://sentry.io/settings/projects/",
  },
  {
    slug: "sentry_client",
    label: "Sentry DSN (browser)",
    emoji: "🛡️",
    envVars: ["NEXT_PUBLIC_SENTRY_DSN"],
    help: "Error tracking for browser errors. NEXT_PUBLIC_ vars are baked into the client bundle at build time — to change this for browsers you still need a redeploy.",
    href: "https://sentry.io/settings/projects/",
  },
  {
    slug: "inngest_event",
    ...
    help: "Publish events to Inngest (powers Agent Workflows).",
  ...
  },
  {
    ...
    help: "Verify Inngest webhook signatures.",
    href: "https://app.inngest.com/env/production/manage/keys",
  },
  {
    ...
    help: "AI VPS endpoint that spawns Claude Code subagents.",
  ...
  },
  {
    ...
    help: "Bearer token for the Agent Runner endpoint.",
  },
  {
    slug: "vercel_token",
    ...
    help: "Used by deploy scripts and the Vercel CLI / MCP.",
    href: "https://vercel.com/account/tokens",
  },
  {
    slug: "supabase_access_token",
    label: "Supabase Access Token",
    emoji: "🐘",
    envVars: ["SUPABASE_ACCESS_TOKEN"],
    help: "Supabase Management API token (used by the supabase CLI for migrations).",
  ...
  },
  {
    ...
    help: "GitHub API access. Used by the GitHub MCP server and any deploy scripts.",
    href: "https://github.com/settings/tokens",
  },
  {
    slug: "vnc_password",
    label: "noVNC Viewer Password",
    emoji: "🔓",
    envVars: ["NEXT_PUBLIC_VNC_PASSWORD"],
    help: "Password the noVNC client uses to connect. NEXT_PUBLIC means the browser sees it — don't reuse a real shared secret here.",
  },
  {
    slug: "vnc_ws_host",
    label: "VNC WebSocket Host",
    emoji: "🌐",
    envVars: ["NEXT_PUBLIC_VNC_WS_HOST"],
    help: "WebSocket hostname for the noVNC viewer.",
  },
  {
    slug: "vnc_ws_base",
    label: "VNC WebSocket Base Path",
    emoji: "🌐",
    envVars: ["NEXT_PUBLIC_VNC_WS_BASE"],
    help: "WebSocket base path for noVNC.",
  },
  {
    slug: "vnc_view_url",
    label: "VNC Viewer Page URL",
    emoji: "🖥️",
    envVars: ["NEXT_PUBLIC_VNC_URL"],
    help: "URL of the embedded noVNC HTML page.",
  },
  {
    slug: "app_url",
    label: "App Base URL",
    emoji: "🌐",
    envVars: ["NEXT_PUBLIC_APP_URL", "NEXT_PUBLIC_SITE_URL"],
    help: "Public URL of the dashboard.",
    placeholder: "https://outreach-github.vercel.app",
  },
  {
    slug: "custom",
